...
# 使い方: bash do_oci_stop.sh <インスタンス名> <コンパートメント名> [OCIプロファイル名]
# 例:     bash do_oci_stop.sh claude-instance-01 dev
...
# ─────────────────────────────────────────
# [3/4] RUNNING状態のインスタンスを検索
# ─────────────────────────────────────────
echo "=== [3/4] インスタンス検索 (name=${INSTANCE_NAME}, state=RUNNING) ==="
